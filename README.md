...
- Highlight Mode: Keeps all threads visible but highlights Provider posts in Green for easy scanning.
- Hide Quotes: Optional toggle to collapse quoted text blocks, reducing clutter and duplicate reading.
...
1. Download the Code:
    ...
    - Note: Ensure you have manifest.json, content.js, and icon.png in the same folder.
...
3. Toggle Filters:
    - Click "Show Providers Only" to hide general user discussions.
    - Check "Infinite Scroll" to browse without clicking "Next Page".
    - Type in the Keyword Box to find specific hardware or locations.
4. Manage View:
